...
function installModule(module,version) {
    activePromise = activePromise.then(() => {
        ...
        return new Promise((resolve,reject) => {
            ...
            var args = process.env.NO_BIN_LINKS? ['install','--no-audit','--no-update-notifier','--no-bin-links','--save','--save-prefix="~"','--production',installName]
                : ['install','--no-audit','--no-update-notifier','--save','--save-prefix="~"','--production',installName];
